...
#
#   config : configs/dome/dfine-<size>-aea.yml      (override: CONFIG=...)
#   tuning : ckpts/dome-<size>-aitod.pth            (override: TUNING=...)
#   outdir : output/dfine-<size>-aea/<timestamp>    (override: OUTDIR=...)
cd "$(dirname "$0")/.." || exit 1
...
TUNING=${TUNING:-./ckpts/Dome-M-AITOD-best.pth}
