    ...
    def adaptive_defe_filter(self, defe_feature, init_thresh=0.05, step=0.01):
        ...
        for b in range(B):
            ...
            if not found:
                ...
                final_mask[b : b + 1][
                    :,
                    random.randint(0, single_feat.shape[1] - 1),
                    random.randint(0, single_feat.shape[2] - 1),
                ] = True
    ...
    def forward(self, feats, img_inputs, targets=None):
        ...
        if self.use_defe:
            ...
            if SAVE_INTERMEDIATE_VISUALIZE_RESULT:
                ...
                visualize_src_flatten(
                    defe_feature.permute(0, 2, 3, 1),
                    [(defe_feature.shape[2:4])],
                    "defe_feature",
                    False,
                )
                visualize_src_flatten(
            ...
            if targets is not None:
                ...
                if SAVE_INTERMEDIATE_VISUALIZE_RESULT:
                    ...
                    visualize_src_flatten(
                        out["defe"]["gt_density_map"].permute(0, 2, 3, 1),
                        [(heatmap.shape[2:4])],
                        "heatmap_gt",
                        False,
                    )
